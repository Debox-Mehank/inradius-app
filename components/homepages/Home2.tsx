...
const Home2 = () => {
  return (
    <div className="h-screen relative overflow-y-auto snap-y snap-mandatory">
      {/* Logo */}
      <div className="z-50 w-full p-8 md:px-20 fixed top-0 left-0 right-0">
      ...
      <section className="w-full h-screen grid lg:grid-cols-2 relative snap-start">
        <div className="h-full bg-white flex flex-col justify-center items-start p-8 md:px-20">
          <h2
            className="text-3xl lg:text-4xl xl:text-banner font-bold text-primary"
            data-aos="fade-right"
          ...
          <h2
            className="text-3xl lg:text-4xl xl:text-banner font-bold"
            data-aos-delay="500"
            data-aos="fade-right"
            data-aos-duration="500"
            data-aos-easing="ease-in-out"
        ...
        <div className="hidden xl:flex h-full bg-black bg-cover bg-center relative flex-col justify-center items-center overflow-hidden">
          ...
          <div className="w-full z-10">
            <div className="opacity-70 w-full">
              <div
                className="w-4/5 mr-auto border-2 border-white rounded-xl text-white pl-12 py-6 -ml-4"
                data-aos-delay="1800"
                data-aos="fade-right"
            ...
            <div className="opacity-70 w-full">
              <div
                className="w-4/5 ml-auto border-2 border-white rounded-xl text-white pl-12 py-6 -mr-4"
                data-aos-delay="2400"
                data-aos="fade-left"
                data-aos-duration="800"
                data-aos-easing="ease-in-out"
            ...
            <div className="opacity-70 w-full">
              ...
              >
                <p
                  ...
                  data-aos-mirror="true"
                >
                  30 minutes of commute takes over{"\n"}
                  <span className="font-bold">an hour</span> in peak time in
                  Mumbai
                </p>
              </div>
            </div>
          ...
          <div
            className="absolute top-0 left-0 right-0 bottom-0 w-full h-full bg-traffic bg-cover"
            data-aos-delay="200"
            data-aos="fade-up"
            data-aos-duration="800"
            data-aos-easing="ease-in-out"
