      ...
      },
      {
        ...
        desc: (
          <p className="text-xs text-white px-1 font-light py-1">
            {
              "Password should be 8-12 characters long with atleast one uppercase letter, containing a number (0-9) and a speacial character (@,#,%,$...)"
            }
          </p>
        ),
      },
    ...
    try {
      ...
      if (resp.data === "Account Doesn't Exist") {
        ...
        const response = await api.post("", {
          ...
          companyName: type === "employer" ? data.companyName : "",
          email: data.email,
          type: type === "employee" ? UserType.employee : UserType.employer,
        ...
        dispatch(
          setUser({
            firstName: data.firstName,
            lastName: data.lastName,
            companyName: type === "employer" ? data.companyName : null,
            email: data.email,
            ...
            <div className="max-w-md w-4/5">
              {type && (
                <ReusableForm
                  ...
                  template={
                    type === "employee"
                      ? EmployeeRegistrationFormTemplate
                      : EmployeerRegistrationFormTemplate
                  }
                  onSubmit={onSubmit}
                  formState={formState}
              ...
              {error === "" ? (
                <p className="text-center text-white font-light text-xs py-2">
                ...
                <p className="text-center text-xs text-red-500 px-1 font-medium py-2">
                  {error}
                  <p className="text-center text-red-500 font-medium text-xs py-2">
